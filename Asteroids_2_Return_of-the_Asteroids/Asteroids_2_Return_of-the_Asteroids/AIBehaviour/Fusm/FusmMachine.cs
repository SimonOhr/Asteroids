        ...
        public void Update()
        {
            ...
            if (states.Count != 0)
            {
                ...
                for (int i = 0; i < states.Count; i++)
                {
                    ...
                    //    else if (states[i].CalculateActivation() < 1)
                    //        nonActiveStates.Add(states[i]);
                    //    else
                    //        activeStates.Add(states[i]);
                    //}
                    //if (states[i].GetName() is "Chase")
                    //{
                    //    var tempActivationLevel = states[i].CalculateActivation();
                    ...
                    //        activeStates.Add(states[i]);
                    //}
                    //else if (states[i].GetName() is "Escape")
                    //{
                    ...
                    //else
                    //{
                    //    var temp = rules.GetLikelyhoodToIdle();
                    //    if (temp == Fusm_RuleBook.LikelyhoodToIdle.low)
                    //        nonActiveStates.Add(states[i]);

                    //    else if (temp == Fusm_RuleBook.LikelyhoodToIdle.medium)
                    //    {
                    //        var tempActivationLevel = states[i].CalculateActivation();
                    //        if (tempActivationLevel + 0.5f >= 1)
                    //            activeStates.Add(states[i]);
